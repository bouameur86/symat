...
<div class="login-box">
    ...
    <div row="inline" class="login-logo">
        <a href="../../index2.html"><b>SYMADA-</b>TE</a> <img class="img-fluid img-thumbnail" src="{{ asset('dashboard_files/img/sonelgaz-te.jpg' )}}" alt="">
    </div><!-- end of login lgo -->

    <div class="login-box-body">
        <p class="login-box-msg">S'identifier pour démarrer votre session</p>
