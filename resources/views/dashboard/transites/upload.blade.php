        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">@lang('site.transites')</li>
                </ol>
            </section>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex">
                                        ...
                                        <a href="{{ route('dashboard.transites.index') }}" class="btn btn-sm btn-primary ml-auto">Return to products</a>
                                    </div>

                                    <div class="card-body">
                                
                                        <form action="{{ route('dashboard.transites.import') }}" method="post" enctype="multipart/form-data">
                                            @csrf
