        ...
        <section class="content">
                    ...
                    <div class="form-group">
                        <label>Niveau de tension</label>
                            <select class="form-control" name="nivU" value="{{ old('nivU') }}" >
                                <option disabled selected>{{ $anomalieexp->nivU }}</option>
            ...
            <div class="form-group">
                ...
                <select id="typeanom" class="form-control" name="typeanom" value="{{ old('typeanom') }}">
                    ...
                    <select id="anomalie" class="form-control" name="anomalie" value={{ $anomalieexp->anomalie }}>
                ...
                <!--   9 Description   -->
                    <div class="form-group"> 
                        ...
                        <textarea type="text" id="descranom" name="descranom" class="form-control"  rows="4"  value={{ $anomalieexp->descranom }} ></textarea>
                    </div>
                    <!--  Boutton de Edit   -->
                        <div class="form-group">
