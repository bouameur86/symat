                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex">
                                        ...
                                        <a href="{{ route('dashboard.comptages.index') }}" class="btn btn-sm btn-primary ml-auto">Return to products</a>
                                    </div>

                                    <div class="card-body">
                                
                                        <form action="{{ route('dashboard.comptages.import') }}" method="post" enctype="multipart/form-data">
                                            @csrf
