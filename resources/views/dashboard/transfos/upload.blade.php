        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('dashboard.transfos.index') }}"><i class="fa fa-gear"></i> @lang('site.transfos')</a></li>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex">
                                        ...
                                        <a href="{{ route('dashboard.transfos.index') }}" class="btn btn-sm btn-primary ml-auto">Return to products</a>
                                    </div>

                                    <div class="card-body">
                                
                                        <form action="{{ route('dashboard.transfos.import') }}" method="post" enctype="multipart/form-data">
                                            @csrf
